...
- `reason`: Why the agent should continue (required if blocking)
- `continue`: If true and blocking, the agent continues working
...
**Usage**: Same as Stop, but for sub-agent completion
