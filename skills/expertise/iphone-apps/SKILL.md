...
The user does not write code. The user does not read code. The user describes what they want and judges whether the result is acceptable. The agent implements, verifies, and reports outcomes.
