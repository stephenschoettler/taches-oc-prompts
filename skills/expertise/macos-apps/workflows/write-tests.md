...
**What the agent tests (automated):**
...
# View results
cncrun xcresulttool get test-results summary --path TestResults.xcresult
```
...
# View coverage
cncrun xccov view --report TestResults.xcresult

# Coverage as JSON
cncrun xccov view --report --json TestResults.xcresult > coverage.json
```
