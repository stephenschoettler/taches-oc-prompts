...
<core_concept>
Orchestration defines how multiple sub-agents coordinate to complete complex tasks.
...
<parallel>
**Parallel/Concurrent pattern**: Multiple specialized sub-agents perform tasks simultaneously.
