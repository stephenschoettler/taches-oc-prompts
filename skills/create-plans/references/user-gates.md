...
User gates prevent the agent from charging ahead at critical decision points.
...
| plan-phase | Question | Multiple valid approaches |
| plan-phase | Question | Decision gate before writing |
| research-phase | Question | Low confidence findings |
...
| execute-phase | Question | Previous phase had issues |
| create-brief | Question | Decision gate before writing |
| create-roadmap | Inline | Confirm phase breakdown |
| create-roadmap | Question | Decision gate before writing |
