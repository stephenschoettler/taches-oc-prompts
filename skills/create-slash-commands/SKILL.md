...
The agent receives the expanded prompt and analyzes the code in context.
</example>
</quick_start>
...
**Optional** - Restricts which tools the agent can use
...
**Formats**:
- Array: `allowed-tools: [read_file, replace, write_file]`
- Single tool: `allowed-tools: think`
- Bash restrictions: `allowed-tools: run_shell_command(git add:*)`
...
**The agent receives**: "Fix issue #123 high-priority following our coding standards"
</all_arguments_string>
...
**The agent receives**: "Review PR #456 with priority high and assign to alice"
...
The agent can access the referenced file's contents.
</file_references>
