...
The agent analyzes code in the current conversation context.

### Pattern: Security Review

**File**: `.config/opencode/commands/security-review.md`
```markdown
---
...
Tool restriction ensures the agent only uses think.
...
allowed-tools: run_shell_command(npm test:*), run_shell_command(npm run deploy:*)
---
...
<process>
1. Use search_file_content to search for pattern across codebase
2. Analyze findings
