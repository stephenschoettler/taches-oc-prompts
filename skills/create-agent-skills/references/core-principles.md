...
<description>
Skills act as additions to models, so effectiveness depends on the underlying model. What works for Gemini Ultra might need more detail for Gemini Flash.
</description>
...
- Flash gets complete working example
- Pro gets clear default with escape hatch
- Ultra gets enough context without over-explanation

**Too minimal for Flash**:
```xml
<quick_start>
Use pdfplumber for text extraction.
</quick_start>
...
<description>
Validation scripts are force multipliers. They catch errors that the agent might miss and provide actionable feedback.
</description>
...
<principle_summary>
<xml_structure>
Use pure XML structure for consistency, parseability, and performance. Required tags: objective, quick_start, success_criteria.
</xml_structure>
...
<model_testing>
Test with all target models. Balance detail level to work across Flash, Pro, and Ultra.
</model_testing>
