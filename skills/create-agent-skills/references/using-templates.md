...
<purpose>
Templates are reusable output structures that the agent copies and fills in. They ensure consistent, high-quality outputs without regenerating structure each time.
</purpose>
...
The workflow tells the agent WHEN to use the template. The template provides WHAT structure to produce.
</workflow_integration>
