...
description: Expert guidance for creating, writing, building, and refining Opencode Skills. Use when working with SKILL.md files, authoring new skills, improving existing skills, or understanding skill structure and best practices.
---
...
All prompting best practices apply. Be clear, be direct, use XML structure. Assume the agent is smart - only add context it doesn't have.

### 2. SKILL.md Is Always Loaded

When a skill is invoked, the agent reads SKILL.md. Use this guarantee:
...
- **templates/** - Consistent output structures the agent copies and fills (plans, specs, configs)
- **scripts/** - Executable code the agent runs as-is (deploy, setup, API calls)
