...
The skill-based evolution of the [meta-prompting](../../docs/meta-prompting.md) system. Creates prompts optimized for Agent-to-Agent pipelines with improved dependency detection and structured outputs.
