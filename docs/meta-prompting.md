...
```
~/.config/opencode/commands/          # Install once
  create-prompt.md
  run-prompt.md
...
With Opencode, token usage doesn't matter as much as **context quality**.
...
Developed by TÂCHES for systematic, high-quality coding workflows.
