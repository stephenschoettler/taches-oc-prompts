...
description: Expert slash command auditor for Opencode slash commands. Use when auditing, reviewing, or evaluating slash command .md files for best practices compliance. MUST BE USED when user asks to audit a slash command.
...
- **File references**: Uses relative paths for file references when appropriate
</area>
