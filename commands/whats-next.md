...
**PRIORITY: Comprehensive detail and precision over brevity.** The goal is to enable someone (or a fresh agent instance) to pick up exactly where you left off with zero information loss.
